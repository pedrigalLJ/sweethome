		...
		<div class="wrapper">
			<nav class="main-header navbar navbar-expand navbar-light">
				...
				<ul class="navbar-nav ml-auto">
					<li class="nav-item">
						<a  href="#" class="nave-link text-danger"data-toggle="modal" data-target="#exampleModal">{{ auth()->user()->free_trial_days_left }} Days of Free Trial left. Click to Subscribe.</a></strong>
					</li>
