        ...
        <div class="row mb-2">
            <div class="col-sm-6">
                <div class="card-tools">
                       <form action="{{ route('admin.user-lists') }}" method="GET">
                        @csrf
            ...
            <div class="col-md-12">
                ...
                <nav>
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        <a class="nav-link active" id="nav-both-tab" data-toggle="tab" href="#nav-both" role="tab" aria-controls="nav-both" aria-selected="true">Seekers</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p class="text-justify">
                                            <a href="#" data-toggle="modal" data-target="#seekerProfile{{ $user->id }}" class="text-success font-weight-bold">{{ $user->given_name.' '.$user->last_name }}</a>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title text-success" id="myModalLabel">{{ $user->given_name.' '.$user->last_name }}</h4>
                                            </div>
