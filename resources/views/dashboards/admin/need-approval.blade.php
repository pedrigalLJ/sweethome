        ...
        <div class="row mb-2">
            <div class="col-sm-6">
                <div class="card-tools">
                       <form action="{{ route('admin.need-approval') }}" method="GET">
                        @csrf
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p class="text-justify">
                                            <a href="#" data-toggle="modal" data-target="#seekerProfile{{ $user->id }}" class="text-warning font-weight-bold">{{ $user->given_name.' '.$user->last_name }}</a>
                                    ...
                                    <td>
                                        <a 
                                            href="{{ route('admin.approve', $user->id) }}"
                                            class="btn btn-success btn-sm mr-2">
                                            <i class="fas fa-check-circle"></i> Approve
                                        </a>
                                            <a 
                                            href="{{ route('admin.decline', $user->id) }}"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title text-warning" id="myModalLabel">{{ $user->given_name.' '.$user->last_name }}</h4>
                                            </div>
                                            <div class="modal-body">
                                                <div class="container">
                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <p class="card-text text-sm text-success">
                            ...
                            @forelse ($agents as $user) 
                                ...
                                <div class="modal fade" id="seekerProfile{{ $user->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title" id="myModalLabel">{{ $user->role->name }}</h4>
                                            ...
                                            <div class="modal-body">
                                                <div class="container">
                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <p class="card-text text-sm text-warning">
                                                                <i class="fas fa-map-marker-alt text-danger"></i> {{$user->city.', '.$user->province}} <br>
                                                                <span class="text-secondary">Location</span>
                                                            </p>
                                                            <hr>
